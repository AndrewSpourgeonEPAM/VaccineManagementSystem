...
public class DoseOneControllerTest {
	...
	@Test
	void testgetDoseOneDetails() throws Exception {
		mockMvc.perform(get("/bookdoseone")).andExpect(view().name("BookDoseOne"));
	}

	@Test
	public void testupdateUserDetails() throws Exception {
		
		verify(userMapper,times(0)).updateUser(userDto);
	}
